...
function validateMessage()
{
    ...
    try
    {
        if(document.getElementById("custom").checked && ((msgBox.value === "") || (msgBox.vale === msgBox.placeholder)))
        {
...
/** Article-Form-Billing Address Section **/
...
function copyBillingAddress()
{
    ...
    else
    {
        ...
        document.querySelector("#deliveryAddress select").value = document.querySelector("#billingAddress select").value = -1;
    }
}
...
/** Article-Form-Delivery Date Section **/
...
function validateNumbers()
{
    ...
    catch(msg)
    {
        ...
        if(cvvNotNum)
        {
            ...
            cvvErrMsg.innerHTML = "The card number " + msg;
        }
...
/** Article-Form-Create Account Section **/
